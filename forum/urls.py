...
from forum.views import events, get_detail_event, delete_detail_event, update_detail_event, create_detail_event, event, get_detail_discussion, get_all_discussion,add_comment,add_discussion
